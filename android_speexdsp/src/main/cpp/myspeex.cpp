...
Java_com_iot_speexdsp_interfaces_SpeexJNIBridge_init(JNIEnv *env, jclass type,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_iot_speexdsp_interfaces_SpeexJNIBridge_destory(JNIEnv *env, jclass type) {
    if (state) {
...
Java_com_iot_speexdsp_interfaces_SpeexJNIBridge_denoise(JNIEnv *env, jclass jcls,
                                                            jbyteArray buffer_) {
...
Java_com_iot_speexdsp_interfaces_SpeexJNIBridge_cancellation(JNIEnv *env, jclass jcls,
